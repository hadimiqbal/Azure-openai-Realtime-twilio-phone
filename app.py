...
async def handle_incoming_call(request: Request):
    ...
    response.say("Please wait while we connect your call to Reflect Health")
    ...
    initial_conversation_item = {
        ...
        "item": {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Greet the user with 'Hello there! I am Jane from Reflect Health. How can I assist you today?'"
                }
            ]
        }
    }
